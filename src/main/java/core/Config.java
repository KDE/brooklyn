...
class Config {
    ...
    public Config(String configFileName) {
        bots = new LinkedHashMap<String, Object>(0);
        channels = new LinkedHashMap<String, Object>(0);
    ...
    private boolean isValidBridges(Iterable bridges, Map<String, Object> channels) {
